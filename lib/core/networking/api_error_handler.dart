...
class ErrorHandler implements Exception {
  ...
  factory ErrorHandler.handle(dynamic error) {
    if (error is DioException) {
      ...
      return ErrorHandler(_handleError(error));
    } else {
      // default error
      return ErrorHandler(DataSource.DEFAULT.getFailure());
    }
  }

  /// Connect the generated [_$ErrorHandlerFromJson] function to the `fromJson`
  /// factory.
  factory ErrorHandler.fromJson(Map<String, dynamic> json) =>
      _$ErrorHandlerFromJson(json);

  /// Connect the generated [_$ErrorHandlerToJson] function to the `toJson` method.
